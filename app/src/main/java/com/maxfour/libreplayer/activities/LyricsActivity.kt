...
import com.maxfour.libreplayer.activities.tageditor.WriteTagsAsyncTask
...
import com.maxfour.libreplayer.lyrics.LrcHelper
import com.maxfour.libreplayer.lyrics.LrcView
import com.maxfour.libreplayer.model.Song
import com.maxfour.libreplayer.model.lyrics.Lyrics
import com.maxfour.libreplayer.util.LyricUtil
...
class LyricsActivity : AbsMusicServiceActivity(), View.OnClickListener, ViewPager.OnPageChangeListener {
		...
		val materialDialog = MaterialDialog(this, BottomSheet(LayoutMode.WRAP_CONTENT))
				.show {
					...
					negativeButton(R.string.action_search) {
						PlayerUtil.openUrl(this@LyricsActivity, googleSearchLrcUrl)
					}
					input(
	...
	private fun showLyricsSaveDialog() {
		...
		val materialDialog = MaterialDialog(
			...
			negativeButton(R.string.action_search) {
				PlayerUtil.openUrl(this@LyricsActivity, getGoogleSearchUrl())
			}
			input(
				hint = getString(R.string.paste_lyrics_here),
				prefill = content,
