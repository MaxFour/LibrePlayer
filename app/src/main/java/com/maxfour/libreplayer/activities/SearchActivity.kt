...
import com.maxfour.libreplayer.adapter.SearchAdapter
import com.maxfour.libreplayer.mvp.presenter.SearchPresenter
import com.maxfour.libreplayer.mvp.presenter.SearchView
...
class SearchActivity : AbsMusicServiceActivity(), OnQueryTextListener, TextWatcher, SearchView {
	...
	private fun hideSoftKeyboard() {
		PlayerUtil.hideSoftKeyboard(this@SearchActivity)
		if (searchView != null) {
