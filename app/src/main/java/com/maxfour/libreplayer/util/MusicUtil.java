...
import com.maxfour.libreplayer.model.lyrics.AbsSynchronizedLyrics;
...
public class MusicUtil {
    ...
    public static void deleteSongs(@NonNull final Activity activity,
        ...
        int batchStart = 0;
        int batchEnd = 0;
        final int batchSize = 1000000 / 10; // 10^6 being the SQLite limite on the query lenth in bytes, 10 being the max number of digits in an int, used to store the song ID
