...
import com.maxfour.libreplayer.dialogs.CreatePlaylistDialog;
...
public class LibraryFragment extends AbsMainActivityFragment implements CabHolder, MainActivityFragmentCallbacks {
    ...
    public MaterialCab openCab(int menuRes, @NonNull MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(getMainActivity(), R.id.cab_stub)
                ...
                .setBackgroundColor(
                        PlayerColorUtil.shiftBackgroundColorForLightText(ATHUtil.INSTANCE.resolveColor(requireContext(), R.attr.colorSurface)))
                .start(callback);
        return cab;
    }
