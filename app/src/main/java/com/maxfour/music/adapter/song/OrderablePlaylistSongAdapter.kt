...
import com.maxfour.music.dialogs.RemoveFromPlaylistDialog
...
class OrderablePlaylistSongAdapter(
	...
	init {
		setMultiSelectMenuRes(com.maxfour.music.R.menu.menu_playlists_songs_selection)
	}
	...
	inner class ViewHolder(itemView: View) : PlaylistSongAdapter.ViewHolder(itemView), DraggableItemViewHolder {
		...
		override var songMenuRes: Int
			get() = com.maxfour.music.R.menu.menu_item_playlist_song
			set(value) {
		...
		override fun onSongMenuItemClick(item: MenuItem): Boolean {
			when (item.itemId) {
				com.maxfour.music.R.id.action_remove_from_playlist -> {
