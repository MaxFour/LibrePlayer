package com.maxfour.music.fragments.mainactivity.folders;
...
import com.maxfour.music.misc.UpdateToastMediaScannerCompletionListener;
...
public class FoldersFragment extends AbsMainActivityFragment implements
    ...
    private void setUpAppbarColor() {
        ...
        toolbar.setBackgroundColor(MusicColorUtil.toolbarColor(getMainActivity()));
    ...
    public MaterialCab openCab(int menuRes, MaterialCab.Callback callback) {
        ...
        cab = new MaterialCab(getMainActivity(), R.id.cab_stub)
                ...
                .setBackgroundColor(MusicColorUtil.shiftBackgroundColorForLightText(ATHUtil.INSTANCE.resolveColor(requireContext(), R.attr.colorPrimary)))
                .start(callback);
        return cab;
    }
