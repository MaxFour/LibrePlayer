...
abstract class AbsBaseActivity : AbsThemeActivity() {
	...
	fun getPermissionDeniedMessage(): String {
		return if (permissionDeniedMessage == null) getString(com.maxfour.music.R.string.permissions_denied) else permissionDeniedMessage!!
	}
				...
				if (grantResult != PackageManager.PERMISSION_GRANTED) {
					if (ActivityCompat.shouldShowRequestPermissionRationale(
						...
						Snackbar.make(
							...
							.setAction(com.maxfour.music.R.string.action_grant) { requestPermissions() }
						...
						Snackbar.make(
								...
								permissionDeniedMessage!!,
								Snackbar.LENGTH_INDEFINITE
						).setAction(com.maxfour.music.R.string.action_settings) {
							val intent = Intent()
