package com.maxfour.music.activities.tageditor
...
abstract class AbsTagEditorActivity : AbsBaseActivity() {
	...
	private fun setUpImageView() {
		loadCurrentImage()
		items = listOf(
				getString(com.maxfour.music.R.string.pick_from_local_storage),
				getString(com.maxfour.music.R.string.web_search),
				getString(com.maxfour.music.R.string.remove_cover)
		)
	...
	protected fun setImageBitmap(bitmap: Bitmap?, bgColor: Int) {
		if (bitmap == null) {
			editorImage.setImageResource(com.maxfour.music.R.drawable.default_album_art)
		} else {
	...
	protected fun writeValuesToFiles(
		...
		MusicPlayerUtil.hideSoftKeyboard(this)
