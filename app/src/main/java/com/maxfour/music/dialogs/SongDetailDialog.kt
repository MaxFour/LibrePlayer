...
class SongDetailDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        trackLength.text = makeTextWithTitle(context, string.label_song_length, "-")
        ...
        if (song != null) {
            ...
            if (songFile.exists()) {
                ...
                try {
                    ...
                    trackLength.text = makeTextWithTitle(context, string.label_song_length, MusicUtil.getReadableDurationString((audioHeader.trackLength * 1000).toLong()))
                    ...
                    // fallback
                    trackLength.text = makeTextWithTitle(context, string.label_song_length, MusicUtil.getReadableDurationString(song.duration))
