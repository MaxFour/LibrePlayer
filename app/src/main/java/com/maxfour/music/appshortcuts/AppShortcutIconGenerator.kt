...
object AppShortcutIconGenerator {
	...
	private fun generateThemedIcon(
		...
		val vectorDrawable = MusicPlayerUtil.getTintedVectorDrawable(context, iconId, foregroundColor)
		val backgroundDrawable = MusicPlayerUtil.getTintedVectorDrawable(
