    ...
    private void addMediaRoots(List<MediaBrowser.MediaItem> mMediaRoot) {
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconBitmap(MusicPlayerUtil.createBitmap(ContextCompat.getDrawable(getApplicationContext(), R.drawable.default_artist_art), 1f))
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconBitmap(MusicPlayerUtil.createBitmap(ContextCompat.getDrawable(getApplicationContext(), R.drawable.default_album_art), 1f))
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://com.maxfour.music/drawable/ic_queue_music_white_24dp"))
                        ...
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems,
                                        ...
                                        Uri.parse("android.resource://com.maxfour.music/drawable/default_artist_art"),
                        ...
                        case TYPE_ALBUM:
                            ...
                            for (Album album : albumList) {
                                fillMediaItems(mediaItems,
                                        ...
                                        album.getTitle(),
                                        album.getArtistName(),
                                        MusicPlayerUtil.getAlbumArtUri(album.getId()),
                                        MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_SONG:
                            ...
                            for (Song song : songList) {
                                fillMediaItems(mediaItems,
                                        ...
                                        song.getTitle(),
                                        song.getAlbumName(),
                                        Uri.parse("android.resource://com.maxfour.music/drawable/default_album_art"),
                        ...
                        case TYPE_PLAYLIST:
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems,
                                        ...
                                        playlist.name,
                                        songCount,
                                        Uri.parse("android.resource://com.maxfour.music/drawable/ic_queue_music_white_24dp"),
                                        MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
